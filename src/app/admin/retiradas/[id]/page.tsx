...
export default function AdminRetiradaDetalhePage() {
  ...
  const carregarRetirada =
    useCallback(async () => {
      ...
      const retiradaCarregada =
        retiradaData as unknown as Retirada;
      ...
      if (!pedidoData) {
        setMensagem(
          "Pedido da retirada não encontrado."
        );
      ...
      <div className="mx-auto max-w-4xl">
        ...
        {pedido.status_pagamento !==
          ...
          <div className="mb-6 rounded-lg border border-orange-300 bg-orange-50 p-4">
            ...
            liberado para separação porque
        ...
        {retirada.status ===
          ...
          <>
            ...
            <div className="mb-8 rounded-xl border-2 border-black p-5">
              ...
              <p className="mt-2 text-sm text-gray-500">
                Passe somente os produtos
                pertencentes a esta retirada.
              </p>
        ...
        {retirada.status ===
          ...
          <div className="mb-8 rounded-xl border border-blue-300 bg-blue-50 p-6">
            ...
            <p className="mt-2">
              ...
              unidade foram conferidos.
              Estamos aguardando o cliente
              realizar o check-in no terminal
              correspondente.
            </p>
          </div>
        )}
        ...
        {retirada.status ===
          ...
          <div className="mb-8 rounded-xl border-2 border-orange-400 bg-orange-50 p-6">
            ...
            <p className="mt-2">
              O cliente realizou o check-in
              desta retirada e está aguardando
              a mercadoria.
            </p>
        ...
        {retirada.status ===
          ...
          <div className="mb-8 rounded-xl border-2 border-green-400 bg-green-50 p-6">
            ...
            <p className="mt-2">
              A entrega física desta retirada
              já foi confirmada.
            </p>
        ...
        {podeConfirmarEntrega && (
          <div className="mt-8 rounded-xl border-2 border-black p-6">
            ...
            <p className="mt-2 text-gray-600">
              Confirme somente depois que os
              produtos desta retirada tiverem
              sido entregues fisicamente ao
              cliente.
            </p>
            ...
            >
              {confirmandoEntrega
                ? "Confirmando entrega..."
                : `Confirmar entrega da Retirada ${retirada.sequencia}`}
            </button>
          </div>
        )}
