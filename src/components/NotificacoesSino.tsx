  ...
  return (
    ...
    >
      <button
        ...
        className="relative flex h-11 w-11 items-center justify-center rounded-full border border-gray-300 bg-white text-xl shadow-sm transition hover:bg-gray-50"
      >
        🔔
