-- =========================================================
-- O BOX DRIVER
-- Conversão de reserva de estoque em pedido aprovado
--
-- Simula o momento em que o gateway de pagamento confirma
-- a venda como APROVADA.
-- =========================================================
...
begin
  ...
  -- =====================================================
  -- 3. GARANTE QUE A RESERVA TEM ITENS
  -- =====================================================
  ...
  -- =====================================================
  -- 4. TRAVA ESTOQUES FÍSICOS ENVOLVIDOS
  --
  -- Ordem determinística para reduzir risco de deadlock.
  -- =====================================================
  ...
  -- =====================================================
  -- 5. VALIDA ESTOQUE FÍSICO
  --
  -- A reserva não baixou o estoque.
  -- Agora precisamos garantir que o físico ainda comporta
  ...
  -- =====================================================
  -- 6. TOTAL COMERCIAL DA RESERVA
  --
  -- Agrupamos por produto para evitar duplicar total
  -- quando o mesmo produto está dividido entre unidades.
  -- =====================================================

  select
    coalesce(
      sum(x.quantidade_total * x.preco_unitario),
      0
    )::numeric(12,2)
  ...
  -- =====================================================
  -- 7. COMPATIBILIDADE TEMPORÁRIA DO PEDIDO
  -- =====================================================
  ...
  -- =====================================================
  -- 10. CRIA ITENS COMERCIAIS
  --
  -- Um item por produto, somando as quantidades de todas
  ...
  -- =====================================================
  -- 11. CRIA UMA RETIRADA POR UNIDADE
  -- =====================================================
  ...
  -- =====================================================
  -- 14. MARCA RESERVA COMO CONVERTIDA
  -- =====================================================
  ...
  -- =====================================================
  -- 15. ATUALIZA CAMPO LEGADO produtos.estoque
  --
  -- Continua apenas por compatibilidade.
  -- =====================================================
